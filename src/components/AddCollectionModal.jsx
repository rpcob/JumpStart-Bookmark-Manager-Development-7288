...
const { FiX, FiPlus, FiUpload } = FiIcons;
...
const AddCollectionModal = ({ onClose, parentId = null }) => {
  const { createCollection, getAllCollections } = useBookmarks();
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-dark-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
            {parentId ? 'Add Sub-Collection' : 'Add Collection'}
          </h2>
          <button
            onClick={onClose}
          ...
          <div>
            ...
            <div className="grid grid-cols-8 gap-2 max-h-40 overflow-y-auto">
              {formData.customIcon && (
                ...
                >
                  <img src={formData.customIcon} alt="Custom" className="w-5 h-5" />
                </button>
              )}
